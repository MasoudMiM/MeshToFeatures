...
from freecad.meshtofeatures_wb.core.history import PadOp
...
class TestGussetedBracket:
    ...
    def test_ramp_slope_survives_burying(self):
        ...
        from freecad.meshtofeatures_wb.core.history import lateral_pad_world_frame
        mesh = gusseted_bracket()
        _, _, plan = _plan(mesh)
...
class TestCurvedProtrusions:
    ...
    def _circle_pad(self, plan):
        from freecad.meshtofeatures_wb.core.history import SketchCircle
...
class TestCylinderConvexity:
    ...
    def test_convexity_sign(self):
        from freecad.meshtofeatures_wb.core.history import _cylinder_convexity
