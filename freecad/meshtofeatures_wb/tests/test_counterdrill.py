...
from freecad.meshtofeatures_wb.core.history import HoleOp, hole_op_properties, plan_history
...
from freecad.meshtofeatures_wb.core.primitives import Cone, Cylinder
