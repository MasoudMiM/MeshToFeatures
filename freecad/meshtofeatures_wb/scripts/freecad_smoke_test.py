...
ADDON_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
if ADDON_ROOT not in sys.path:
    sys.path.insert(0, ADDON_ROOT)

import pkgutil  # noqa: E402
import freecad  # noqa: E402  (FreeCAD's own, or ours -- both pkgutil-style)
...
if cdcount:
    from freecad.meshtofeatures_wb.core.history import hole_op_properties
